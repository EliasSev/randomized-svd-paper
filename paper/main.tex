...
Comparing the computational time of rSVD on wide data, $t_{wide}$, to tall data, $t_{tall}$, I look at the ratio $t_{wide} / t_{tall}$ to assess the advantage of performing the method on wide versus tall data. If this value is greater than 1, then $t_{wide} > t_{tall}$, and hence rSVD performs quicker on tall data compared to wide data. 
