...
%\input{tables/matrix_count.tex}  % TABLE I
...
\input{tables/times_all.tex}  % TABLE II
...
\input{tables/times_tall_wide.tex}  % TABLE III
...
Scikit-learn provides an implementation of rSVD located within \texttt{sklearn/utils/extmath} \cite{pedregosa2011scikit}, which transposes $A\in\mathbb R^{m\times n}$ under the criteria that $m < n$.
