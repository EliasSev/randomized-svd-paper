...
Consider the goal of finding a rank-$k$ approximation to an $m \times n$ matrix $A$. We seek a matrix $X$ with $\text{rank}(X) \le k$ which approximates $A$. The problem formulation is
