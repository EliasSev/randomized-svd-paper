...
\begin{tabular}{ccccccc}
    ...
    \midrule
    5  & 13.03 & 13.03 & 6.15 & 6.15 & 24.79 & 24.79 \\
    10 & 10.39 & 10.39 & 5.82 & 5.82 & 17.64 & 17.64 \\
    20 & 0.21 & 0.21 & 2.91 & 2.91 & 12.72 & 12.72 \\
    30 & 0.20 & 0.20 & 2.57 & 2.57 & 10.89 & 10.89 \\
    40 & 0.20 & 0.20 & 2.45 & 2.45 & 10.01 & 10.01 \\
    50 & 0.19 & 0.19 & 2.27 & 2.27 & 9.41 & 9.41 \\
    \bottomrule
\end{tabular}
\end{table}
...
For the small case, $n_s=100$, the computational time for the rSVD if much faster than for SVD for ranks $k<10$. For $k=10$ and above, SVD performs better, both on wide data and tall data.

The medium case, where $n_m=500$, the computational time of SVD is higher for all values of $k$ compared to the rSVD. The difference between the two methods reduces as $k$ increases, and for $k=50$ rSVD is $20\%$ faster.
